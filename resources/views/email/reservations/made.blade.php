...
{{ __("A new reservation has been made!") }}
...
@endcomponent
@endif
@if ($reservation->surcharges->count() > 0)
@component('mail::table')
|{{ __("Surcharges") }}||
| :------------------------------------------------ |:--------------------------------------------------------------------------|
@foreach ($reservation->surcharges as $surcharge)
...
| {{ __("Already paid by credit card") }}    | {{ config('resrv-config.currency_symbol') }} {{ $reservation->payableNow()->format() }} |
