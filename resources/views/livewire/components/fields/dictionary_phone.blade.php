...
>
    ...
    >
        <div class="relative flex w-full">
            <button 
                type="button"
                class="inline-flex w-max items-center justify-between gap-2 whitespace-nowrap rounded-l-md border border-gray-300 bg-gray-50 border-r-0 px-4 py-2.5 font-medium tracking-wide transition hover:opacity-75 focus-visible:outline-none focus-visible:gray-300 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
                role="combobox"
                aria-controls="list"
            ...
            >
                <div class="relative">
                    ...
                    <input 
                        type="text"
                        class="w-full border-b border-gray-300 bg-gray-50 py-2.5 pl-11 pr-4 text-sm text-gray-600 focus:outline-none focus-visible:border-blue-600 disabled:cursor-not-allowed disabled:opacity-75"
                        name="searchField"
                        aria-label="Search"
